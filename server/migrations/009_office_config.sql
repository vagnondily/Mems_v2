...
--
--  Ni SQLite ni ce portage n'ajoutent de contrainte CHECK ici : la valeur
...
ALTER TABLE offices ADD COLUMN antennes   jsonb NOT NULL DEFAULT '[]'::jsonb;
...
ALTER TABLE offices ADD COLUMN lon        double precision;
...
ALTER TABLE offices ADD COLUMN updated_at timestamptz;
