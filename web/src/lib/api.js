...
export const api = {
  ...
  setContractStatus:(id, status) => call("PUT", `/tpm/contracts/${encodeURIComponent(id)}/status`, { status }),
  cloneContract:  (id)           => call("POST", `/tpm/contracts/${encodeURIComponent(id)}/clone`, {}),
  ...
  contractZones:  (id)           => call("GET", `/tpm/contracts/${encodeURIComponent(id)}/zones`),
  saveContractZones:(id, zones)  => call("PUT", `/tpm/contracts/${encodeURIComponent(id)}/zones`, { zones }),
